...
<form name='sendmail' action='send.php' method='post'>
	...
	<table width='500' border='0' cellpadding='0' cellspacing='0' style='border:1px solid #999999;'>
		...
		<tr height='30'>
			...
			<td style='border-bottom:1px solid #999999;'>
				<input type='text' name='form_user' placeholder='donggyu5878@gmail.com' value='donggyu5878@gmail.com' readonly=''>
			</td>
		</tr>
		<tr height='30'>
		...
		<tr height='30'>
			...
			<td>
				<textarea name='content' style='width:380px; height:100px;'></textarea>
			</td>
		</tr>
	</table>
	...
	<table width='500' border='0' cellpadding='0' cellspacing='0'>
		<tr height='50'>
			<td align='center'>
				<input type='button' value='메일 보내기' onclick='check();'>
			</td>
		</tr>
	</table>
</form>